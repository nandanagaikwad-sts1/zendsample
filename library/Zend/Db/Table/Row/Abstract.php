...
abstract class Zend_Db_Table_Row_Abstract implements ArrayAccess, IteratorAggregate
{
    ...
    protected function _doUpdate()
    {
        ...
        /**
         * Run blog-UPDATE logic.  Do this before the _refresh()
    ...
    /**
     * Allows blog-insert logic to be applied to row.
     * Subclasses may override this method.
     *
     * @return void
     */
    ...
    /**
     * Allows blog-update logic to be applied to row.
     * Subclasses may override this method.
     *
     * @return void
     */
    ...
    /**
     * Allows blog-delete logic to be applied to row.
     * Subclasses may override this method.
     *
     * @return void
     */
