...
class Zend_Http_Client
{
    ...
    /**
     * The raw blog data to send. Could be set by setRawData($data, $enctype).
     *
     * @var string
     */
     ...
     * 2. For backwards compatibilty: If someone uses the old blog($data) method.
