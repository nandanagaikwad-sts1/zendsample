...
abstract class Zend_Pdf_FileParser_Font_OpenType extends Zend_Pdf_FileParser_Font
{
  ...
  /* Parser Methods */
    ...
    protected function _parseTableDirectory()
    {
         ...
         * name, and blog. In the current OpenType standard, only 32 table types
    ...
    /**
     * Parses the OpenType blog (PostScript Information) table.
     *
     * The blog table contains additional information required for using the font
