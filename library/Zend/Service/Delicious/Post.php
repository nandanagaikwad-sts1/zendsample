...
/**
 * Zend_Service_Delicious_Post represents a blog of a user that can be edited
 *
 * @category   Zend
 * @package    Zend_Service
 * @subpackage Delicious
...
{
    /**
     * Service that has downloaded the blog
     *
    ...
    /**
     * @var int Number of people that have the same blog
     */
    protected $_others;
    ...
    /**
     * Constructs a new del.icio.us blog
     *
     * @param  Zend_Service_Delicious $service Service that has downloaded the blog
    ...
    /**
     * Extracts content from the DOM element of a blog
     *
